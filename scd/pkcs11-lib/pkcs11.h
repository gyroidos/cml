...
typedef ck_rv_t (*ck_notify_t)(ck_session_handle_t session, ck_notification_t event,
			       void *application);
...
_CK_DECLARE_FUNCTION(C_GetMechanismList, (ck_slot_id_t slot_id, ck_mechanism_type_t *mechanism_list,
					  unsigned long *count));
_CK_DECLARE_FUNCTION(C_GetMechanismInfo, (ck_slot_id_t slot_id, ck_mechanism_type_t type,
					  struct ck_mechanism_info *info));
_CK_DECLARE_FUNCTION(C_InitToken, (ck_slot_id_t slot_id, unsigned char *pin, unsigned long pin_len,
				   unsigned char *label));
_CK_DECLARE_FUNCTION(C_InitPIN,
		     (ck_session_handle_t session, unsigned char *pin, unsigned long pin_len));
_CK_DECLARE_FUNCTION(C_SetPIN,
		     (ck_session_handle_t session, unsigned char *old_pin, unsigned long old_len,
		      unsigned char *new_pin, unsigned long new_len));

_CK_DECLARE_FUNCTION(C_OpenSession, (ck_slot_id_t slot_id, ck_flags_t flags, void *application,
...
_CK_DECLARE_FUNCTION(C_GetOperationState,
		     (ck_session_handle_t session, unsigned char *operation_state,
		      unsigned long *operation_state_len));
_CK_DECLARE_FUNCTION(C_SetOperationState,
		     (ck_session_handle_t session, unsigned char *operation_state,
		      unsigned long operation_state_len, ck_object_handle_t encryption_key,
		      ck_object_handle_t authentication_key));
_CK_DECLARE_FUNCTION(C_Login, (ck_session_handle_t session, ck_user_type_t user_type,
			       unsigned char *pin, unsigned long pin_len));
_CK_DECLARE_FUNCTION(C_Logout, (ck_session_handle_t session));

_CK_DECLARE_FUNCTION(C_CreateObject, (ck_session_handle_t session, struct ck_attribute *templ,
				      unsigned long count, ck_object_handle_t *object));
_CK_DECLARE_FUNCTION(C_CopyObject, (ck_session_handle_t session, ck_object_handle_t object,
...
_CK_DECLARE_FUNCTION(C_GetAttributeValue, (ck_session_handle_t session, ck_object_handle_t object,
					   struct ck_attribute *templ, unsigned long count));
_CK_DECLARE_FUNCTION(C_SetAttributeValue, (ck_session_handle_t session, ck_object_handle_t object,
					   struct ck_attribute *templ, unsigned long count));
_CK_DECLARE_FUNCTION(C_FindObjectsInit, (ck_session_handle_t session, struct ck_attribute *templ,
					 unsigned long count));
_CK_DECLARE_FUNCTION(C_FindObjects, (ck_session_handle_t session, ck_object_handle_t *object,
...
_CK_DECLARE_FUNCTION(C_EncryptInit, (ck_session_handle_t session, struct ck_mechanism *mechanism,
				     ck_object_handle_t key));
_CK_DECLARE_FUNCTION(C_Encrypt,
		     (ck_session_handle_t session, unsigned char *data, unsigned long data_len,
...
_CK_DECLARE_FUNCTION(C_EncryptFinal,
		     (ck_session_handle_t session, unsigned char *last_encrypted_part,
		      unsigned long *last_encrypted_part_len));

_CK_DECLARE_FUNCTION(C_DecryptInit, (ck_session_handle_t session, struct ck_mechanism *mechanism,
				     ck_object_handle_t key));
_CK_DECLARE_FUNCTION(C_Decrypt, (ck_session_handle_t session, unsigned char *encrypted_data,
				 unsigned long encrypted_data_len, unsigned char *data,
				 unsigned long *data_len));
_CK_DECLARE_FUNCTION(C_DecryptUpdate, (ck_session_handle_t session, unsigned char *encrypted_part,
				       unsigned long encrypted_part_len, unsigned char *part,
				       unsigned long *part_len));
_CK_DECLARE_FUNCTION(C_DecryptFinal, (ck_session_handle_t session, unsigned char *last_part,
...
_CK_DECLARE_FUNCTION(C_DigestFinal, (ck_session_handle_t session, unsigned char *digest,
				     unsigned long *digest_len));

_CK_DECLARE_FUNCTION(C_SignInit, (ck_session_handle_t session, struct ck_mechanism *mechanism,
				  ck_object_handle_t key));
...
_CK_DECLARE_FUNCTION(C_SignUpdate,
		     (ck_session_handle_t session, unsigned char *part, unsigned long part_len));
_CK_DECLARE_FUNCTION(C_SignFinal, (ck_session_handle_t session, unsigned char *signature,
				   unsigned long *signature_len));
_CK_DECLARE_FUNCTION(C_SignRecoverInit, (ck_session_handle_t session,
					 struct ck_mechanism *mechanism, ck_object_handle_t key));
_CK_DECLARE_FUNCTION(C_SignRecover,
		     (ck_session_handle_t session, unsigned char *data, unsigned long data_len,
		      unsigned char *signature, unsigned long *signature_len));

_CK_DECLARE_FUNCTION(C_VerifyInit, (ck_session_handle_t session, struct ck_mechanism *mechanism,
				    ck_object_handle_t key));
...
_CK_DECLARE_FUNCTION(C_VerifyUpdate,
		     (ck_session_handle_t session, unsigned char *part, unsigned long part_len));
_CK_DECLARE_FUNCTION(C_VerifyFinal, (ck_session_handle_t session, unsigned char *signature,
				     unsigned long signature_len));
_CK_DECLARE_FUNCTION(C_VerifyRecoverInit, (ck_session_handle_t session,
					   struct ck_mechanism *mechanism, ck_object_handle_t key));
_CK_DECLARE_FUNCTION(C_VerifyRecover,
		     (ck_session_handle_t session, unsigned char *signature,
		      unsigned long signature_len, unsigned char *data, unsigned long *data_len));

_CK_DECLARE_FUNCTION(C_DigestEncryptUpdate,
		     (ck_session_handle_t session, unsigned char *part, unsigned long part_len,
		      unsigned char *encrypted_part, unsigned long *encrypted_part_len));
_CK_DECLARE_FUNCTION(C_DecryptDigestUpdate,
		     (ck_session_handle_t session, unsigned char *encrypted_part,
		      unsigned long encrypted_part_len, unsigned char *part,
		      unsigned long *part_len));
...
_CK_DECLARE_FUNCTION(C_GenerateKey,
		     (ck_session_handle_t session, struct ck_mechanism *mechanism,
		      struct ck_attribute *templ, unsigned long count, ck_object_handle_t *key));
_CK_DECLARE_FUNCTION(C_GenerateKeyPair,
		     (ck_session_handle_t session, struct ck_mechanism *mechanism,
		      struct ck_attribute *public_key_template,
		      unsigned long public_key_attribute_count,
		      struct ck_attribute *private_key_template,
		      unsigned long private_key_attribute_count, ck_object_handle_t *public_key,
		      ck_object_handle_t *private_key));
_CK_DECLARE_FUNCTION(C_WrapKey, (ck_session_handle_t session, struct ck_mechanism *mechanism,
				 ck_object_handle_t wrapping_key, ck_object_handle_t key,
				 unsigned char *wrapped_key, unsigned long *wrapped_key_len));
_CK_DECLARE_FUNCTION(C_UnwrapKey, (ck_session_handle_t session, struct ck_mechanism *mechanism,
				   ck_object_handle_t unwrapping_key, unsigned char *wrapped_key,
				   unsigned long wrapped_key_len, struct ck_attribute *templ,
				   unsigned long attribute_count, ck_object_handle_t *key));
_CK_DECLARE_FUNCTION(C_DeriveKey, (ck_session_handle_t session, struct ck_mechanism *mechanism,
...
_CK_DECLARE_FUNCTION(C_GenerateRandom, (ck_session_handle_t session, unsigned char *random_data,
					unsigned long random_len));
...
_CK_DECLARE_FUNCTION(C_GetInterfaceList,
		     (struct ck_interface * interfaces_list, unsigned long *count));
_CK_DECLARE_FUNCTION(C_GetInterface, (unsigned char *interface_name, struct ck_version *version,
				      struct ck_interface **interface_, ck_flags_t flags));

_CK_DECLARE_FUNCTION(C_LoginUser,
		     (ck_session_handle_t session, ck_user_type_t user_type, unsigned char *pin,
		      unsigned long pin_len, unsigned char *username, unsigned long username_len));

_CK_DECLARE_FUNCTION(C_SessionCancel, (ck_session_handle_t session, ck_flags_t flags));
...
_CK_DECLARE_FUNCTION(C_EncryptMessage,
		     (ck_session_handle_t session, void *parameter, unsigned long parameter_len,
		      unsigned char *associated_data, unsigned long associated_data_len,
...
_CK_DECLARE_FUNCTION(C_EncryptMessageNext,
		     (ck_session_handle_t session, void *parameter, unsigned long parameter_len,
		      unsigned char *plaintext_part, unsigned long plaintext_part_len,
		      unsigned char *ciphertext_part, unsigned long *ciphertext_part_len,
		      ck_flags_t flags));
_CK_DECLARE_FUNCTION(C_MessageEncryptFinal, (ck_session_handle_t session));
...
_CK_DECLARE_FUNCTION(C_DecryptMessageNext,
		     (ck_session_handle_t session, void *parameter, unsigned long parameter_len,
		      ...
		      unsigned char *plaintext_part, unsigned long *plaintext_part_len,
		      ck_flags_t flags));
_CK_DECLARE_FUNCTION(C_MessageDecryptFinal, (ck_session_handle_t session));

_CK_DECLARE_FUNCTION(C_MessageSignInit, (ck_session_handle_t session,
					 struct ck_mechanism *mechanism, ck_object_handle_t key));
_CK_DECLARE_FUNCTION(C_SignMessage,
		     (ck_session_handle_t session, void *parameter, unsigned long parameter_len,
		      unsigned char *data, unsigned long data_len, unsigned char *signature,
		      unsigned long *signature_len));
...
_CK_DECLARE_FUNCTION(C_SignMessageNext,
		     (ck_session_handle_t session, void *parameter, unsigned long parameter_len,
		      unsigned char *data, unsigned long data_len, unsigned char *signature,
		      unsigned long *signature_len));
_CK_DECLARE_FUNCTION(C_MessageSignFinal, (ck_session_handle_t session));

_CK_DECLARE_FUNCTION(C_MessageVerifyInit, (ck_session_handle_t session,
					   struct ck_mechanism *mechanism, ck_object_handle_t key));
...
_CK_DECLARE_FUNCTION(C_VerifyMessageNext,
		     (ck_session_handle_t session, void *parameter, unsigned long parameter_len,
		      unsigned char *data, unsigned long data_len, unsigned char *signature,
		      unsigned long signature_len));
_CK_DECLARE_FUNCTION(C_MessageVerifyFinal, (ck_session_handle_t session));

_CK_DECLARE_FUNCTION(C_EncapsulateKey,
		     (ck_session_handle_t session, struct ck_mechanism *mechanism,
		      ck_object_handle_t public_key, struct ck_attribute *templ,
		      unsigned long attribute_count, unsigned char *ciphertext,
		      unsigned long *ciphertext_len, ck_object_handle_t *key_ptr));
_CK_DECLARE_FUNCTION(C_DecapsulateKey,
		     (ck_session_handle_t session, struct ck_mechanism *mechanism,
		      ck_object_handle_t private_key, struct ck_attribute *templ,
		      unsigned long attribute_count, unsigned char *ciphertext,
		      unsigned long *ciphertext_len, ck_object_handle_t *key_ptr));
_CK_DECLARE_FUNCTION(C_VerifySignatureInit,
		     (ck_session_handle_t session, struct ck_mechanism *mechanism,
		      ck_object_handle_t key, unsigned char *signature,
		      unsigned long signature_len));
_CK_DECLARE_FUNCTION(C_VerifySignature,
		     (ck_session_handle_t session, unsigned char *data, unsigned long data_len));
_CK_DECLARE_FUNCTION(C_VerifySignatureUpdate,
		     (ck_session_handle_t session, unsigned char *part, unsigned long part_len));
_CK_DECLARE_FUNCTION(C_VerifySignatureFinal, (ck_session_handle_t session));
_CK_DECLARE_FUNCTION(C_GetSessionValidationFlags,
		     (ck_session_handle_t session, ck_session_validation_flags_type_t type,
		      ck_flags_t *flags_ptr));
_CK_DECLARE_FUNCTION(C_AsyncComplete, (ck_session_handle_t session, unsigned char *function_name,
				       struct ck_async_data *result));
_CK_DECLARE_FUNCTION(C_AsyncGetID, (ck_session_handle_t session, unsigned char *function_name,
				    unsigned long *id_ptr));
_CK_DECLARE_FUNCTION(C_AsyncJoin, (ck_session_handle_t session, unsigned char *function_name,
				   unsigned long id, unsigned char *data, unsigned long data_len));
...
_CK_DECLARE_FUNCTION(C_UnwrapKeyAuthenticated,
		     (ck_session_handle_t session, struct ck_mechanism *mechanism,
		      ck_object_handle_t unwrapping_key, unsigned char *wrapped_key,
		      unsigned long wrapped_key_len, struct ck_attribute *templ,
		      unsigned long attribute_count, unsigned char *associated_data,
		      unsigned long associated_data_len, ck_object_handle_t *key_ptr));
