 ...
 */
static int __android_log_processLogBuffer(struct logger_entry_ns *buf,
                                          char *buf_msg,
...
int android_log_processLogBuffer_ns(struct logger_entry_ns *buf,
                                    AndroidLogEntry *entry)
{
 ...
 * here.
 */
static int __android_log_processBinaryLogBuffer_ns(struct logger_entry_ns *buf,
                                                   const char *buf_msg,
                                                   AndroidLogEntry *entry,
...
int android_log_processBinaryLogBuffer_ns(struct logger_entry_ns *buf,
    AndroidLogEntry *entry, const EventTagMap* map, char* messageBuf,
    int messageBufLen)
{
