...
tss2_destroy(void)
{
	// We do nothing here because destroying the esys_context would invalidate all TPM resource
	// handles, including the ones that we use for the entire runtime of tpm2d such as
